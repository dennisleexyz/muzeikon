...
class RedirectActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (MuzeiContract.Sources.isProviderSelected(this, BuildConfig.AUTHORITY)
                && launchIntent != null) {
        ...
        val intents = listOf(
                MuzeiContract.Sources.createChooseProviderIntent(BuildConfig.AUTHORITY)
                        to R.string.toast_enable,
                launchIntent
                        to R.string.toast_enable_source,
